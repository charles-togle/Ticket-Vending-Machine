...
class Person implements Student {
  ...
  greet(): string {
    return `Hello ${this.Name}, you are probably ${
      this.Age
    } years old and lives in ${this.Address}, your student ID is ${
      this.StudentID
    }, and you are currently ${
      this.Enrolled ? "enrolled" : "not yet enrolled"
    }`;
  }
}
...
console.log(sampleDictionary["Charles"] + " and " + sampleDictionary["Stefanie"]);
